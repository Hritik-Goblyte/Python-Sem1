...
root = Tk()
root.title('Hritik Library Management System')
root.geometry('1010x530')
root.resizable(0, 0)

Label(root, text='Hritik LIBRARY MANAGEMENT SYSTEM', font=("Noto Sans CJK TC", 15, 'bold'), bg=btn_hlb_bg, fg='White').pack(side=TOP, fill=X)
