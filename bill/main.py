...
conn = mysql.connector.connect(user='root', password='', host='localhost', database='store')
myc = conn.cursor()
...
while o == "y" or o == "Y":
    ...
    if c == "S" or c == "s":
        ...
        mobile_number = int(input("customer's mobile number:"))
        total = 0
        ...
        if impt <= maxitem:
            ...
            if total < 800:
                ...
                dprice = total * discount  # discount amount
                print("Final price:", price - dprice)
            elif 6000 < total <= 11000:
                discount = 15 / 100
                dprice = total * discount
                print("Final price:", price - dprice)
            elif 11000 < total <= 15000:
                discount = 20 / 100
                dprice = total * discount
                print("Final price:", price - dprice)
            elif total > 15000:
        ...
        if impt <= maxitem:
            ...
            if total < 1200:
                print("Final price:", price)
            elif 1200 <= total <= 4000:
                discount = 5 / 100
                dprice = total * discount  # discount amount
                print("Final price:", price - dprice)
            elif 4000 < total <= 7000:
                discount = 15 / 100
                dprice = total * discount
                print("Final price:", price - dprice)
            elif 7000 < total <= 12000:
                discount = 20 / 100
                dprice = total * discount
                print("Final price:", price - dprice)
            elif total > 12000:
